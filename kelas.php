  ...
  <body>
    ...
    <div class="container">
        ...
        if (isset($_POST["OK"])){
           ...
           echo "<div class='alert alert-success'>  SUKSES MENGINPUT!</div>";
        }
        ?>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="" name="id_kelas">
    </div>
    <div class="form-group">
        <label> nama_kelas</label>
        <input type="text" class="form-control" placeholder="" name="nama_kelas">
    </div>
    <div class="form-group">
        <label> kompetensi_keahlian</label>
        <input type="text" class="form-control" placeholder="" name="kompetensi_keahlian">
    <br>
